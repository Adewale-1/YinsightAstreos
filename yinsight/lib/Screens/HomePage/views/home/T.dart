              ...
              Expanded(
                child: ListView(
                  children: [
                    ...
                    const SizedBox(
                        height: 20), // 2% of the screen height for spacing
                    Row(
                      children: [
                        Expanded(
                          child: RecallCard(
                            ...
                            height:
                                screenHeight * 0.2, // 10% of the screen height
                          ),
                        ),
                        SizedBox(
                            width: screenWidth *
                                0.02), // 2% of the screen width for spacing
                        Expanded(
                          child: ReflectionCard(
                            ...
                            cardHeight:
                                screenHeight * 0.2, // 10% of the screen height
                            cardWidth:
                                screenWidth * 0.45, // 45% of the screen width
                          ),
                        ),
                      ],
                    ),
